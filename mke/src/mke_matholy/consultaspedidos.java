...
//creamos una clase publica con los siguientes metodos asignados a las variables
    ...
    public consultaspedidos() {
        ...
        try {
            ...
            String sql ="select ID_PEDIDO,FECHA,NOMBRE_CHA,CANTIDAD,NOMBRE_CLIENTE,DOC_CLIENTE,DOC_EMPLEADO from PEDIDO";
    ...
    private void initComponents() {
        ...
        tipousuario7 = new javax.swing.JLabel();
        ...
        tablaproduc.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id pedido", "Fecha", "Nombre chaqueta", "Cantidad", "Nombre cliente", "Documento cliente", "Documento empleado"
            }
        ) {
        ...
        items.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID PEDIDO", "FECHA DE PEDIDO", "NOMBRE CHAQUETA", "CANTIDAD", "NOMBRE DEL CLIENTE", "DOC CLIENTE", "DOC EMPLEADO" }));
        ...
        titulo.setText("Registros de los pedidos");
        ...
        titulo.setBounds(310, 30, 490, 40);
        ...
        editar.setBounds(730, 600, 65, 65);

        tipousuario7.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        getContentPane().add(tipousuario7);
        tipousuario7.setBounds(130, 40, 150, 30);
    ...
    if(consultar.equals("ID PEDIDO"))//si el dato escogido es igual a id realice lo siguiente 
    {
        try {
            DefaultTableModel modelo=new DefaultTableModel();
            tablaproduc.setModel(modelo);
            ...
            String sql ="select ID_PEDIDO,FECHA,NOMBRE_CHA,CANTIDAD,NOMBRE_CLIENTE,DOC_CLIENTE,DOC_EMPLEADO from PEDIDO where ID_PEDIDO= ? ";
            ps=con.prepareStatement(sql);
    ...
    if(consultar.equals("FECHA DE PEDIDO"))//si el dato escogido es igual a nombrematerial  realice lo siguiente 
    {
        ...
        try {
            ...
            String sql ="select ID_PEDIDO,FECHA,NOMBRE_CHA,CANTIDAD,NOMBRE_CLIENTE,DOC_CLIENTE,DOC_EMPLEADO from PEDIDO where FECHA LIKE '"+ress+"' ";
            ps=con.prepareStatement(sql);
    ...
    if(consultar.equals("NOMBRE CHAQUETA"))//si el dato escogido es igual a cantidad  realice lo siguiente
    {
        ...
        try {
            ...
            String sql ="select ID_PEDIDO,FECHA,NOMBRE_CHA,CANTIDAD,NOMBRE_CLIENTE,DOC_CLIENTE,DOC_EMPLEADO from PEDIDO where NOMBRE_CHA like '%"+ress+"%' ";
            ps=con.prepareStatement(sql);
            //ps.setInt(1,Integer.parseInt(registro.getText()));
            rs=ps.executeQuery();
    ...
    if(consultar.equals("CANTIDAD"))//si el dato escogido es igual a precio  realice lo siguiente
    {
        ...
        try {
            ...
            String sql ="select ID_PEDIDO,FECHA,NOMBRE_CHA,CANTIDAD,NOMBRE_CLIENTE,DOC_CLIENTE,DOC_EMPLEADO from PEDIDO where CANTIDAD= ? ";
            ps=con.prepareStatement(sql);
            ps.setInt(1,Integer.parseInt(registro.getText()));
            rs=ps.executeQuery();
        ...
        if(consultar.equals("NOMBRE DEL CLIENTE"))//si el dato escogido es igual a precio  realice lo siguiente
    {
            String  ress= registro.getText();
        try {
            DefaultTableModel modelo=new DefaultTableModel();
            ...
            String sql ="select ID_PEDIDO,FECHA,NOMBRE_CHA,CANTIDAD,NOMBRE_CLIENTE,DOC_CLIENTE,DOC_EMPLEADO from PEDIDO where NOMBRE_CLIENTE like '%"+ress+"%' ";
            ps=con.prepareStatement(sql);
            //ps.setInt(1,Integer.parseInt(registro.getText()));
            rs=ps.executeQuery();
        ...
        if(consultar.equals("DOC CLIENTE"))//si el dato escogido es igual a precio  realice lo siguiente
    {
        ...
        try {
            ...
            String sql ="select ID_PEDIDO,FECHA,NOMBRE_CHA,CANTIDAD,NOMBRE_CLIENTE,DOC_CLIENTE,DOC_EMPLEADO from PEDIDO where DOC_CLIENTE= ? ;";
            ps=con.prepareStatement(sql);
            ps.setInt(1,Integer.parseInt(registro.getText()));
            rs=ps.executeQuery();
 ...
 if(consultar.equals("DOC EMPLEADO"))//si el dato escogido es igual a precio  realice lo siguiente
    {
        try {
            ...
            String sql ="select ID_PEDIDO,FECHA,NOMBRE_CHA,CANTIDAD,NOMBRE_CLIENTE,DOC_CLIENTE,DOC_EMPLEADO from PEDIDO where DOC_EMPLEADO= ? ;";
            ps=con.prepareStatement(sql);
            ps.setInt(1,Integer.parseInt(registro.getText()));
            rs=ps.executeQuery();
    ...
    private void VolverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VolverActionPerformed
        menupedidos mp=new menupedidos();//cuando de click en volver lo envie al modulo de materi prima 
        mp.setVisible(true);
        dispose();
        if (tipousuario7.getText().equals("USUARIO")){
                mp.tipousuario18.setText("USUARIO");
        }
        if(tipousuario7.getText().equals("ADMINISTRADOR")){
                mp.tipousuario18.setText("ADMINISTRADOR");
        }
    ...
    private void editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarActionPerformed
        crudpedidos cm=new crudpedidos();
        cm.setVisible(true);
        dispose();
        if (tipousuario7.getText().equals("USUARIO")){
                cm.tipousuario13.setText("USUARIO");
        }
        if(tipousuario7.getText().equals("ADMINISTRADOR")){
                cm.tipousuario13.setText("ADMINISTRADOR");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(consultaspedidos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new consultaspedidos().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JLabel tipousuario7;
