...
public class opccha extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tipousuario22 = new javax.swing.JLabel();
        ...
        titulo.setText("Menú del modulo chaquetas terminadas");
        ...
        titulo.setBounds(160, 50, 790, 90);
        ...
        consultar.setBounds(540, 220, 180, 180);
        ...
        eliminar.setBounds(250, 220, 180, 180);
        ...
        volver.setBounds(450, 470, 65, 65);

        tipousuario22.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        getContentPane().add(tipousuario22);
        tipousuario22.setBounds(20, 120, 140, 30);
    ...
    private void consultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarActionPerformed
        consulproductos con=new consulproductos();
        con.setVisible(true);
        dispose();
        if (tipousuario22.getText().equals("USUARIO")){
                con.tipousuario3.setText("USUARIO");
        }
        if(tipousuario22.getText().equals("ADMINISTRADOR")){
                con.tipousuario3.setText("ADMINISTRADOR");
        }
    ...
    private void eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarActionPerformed
        crudproductos el=new crudproductos();
        el.setVisible(true);
        dispose();
        if (tipousuario22.getText().equals("USUARIO")){
                el.tipousuario14.setText("USUARIO");
        }
        if(tipousuario22.getText().equals("ADMINISTRADOR")){
               el.tipousuario14.setText("ADMINISTRADOR");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(opccha.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public javax.swing.JLabel tipousuario22;
