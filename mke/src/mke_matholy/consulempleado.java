...
//creamos una clase publica con los siguientes metodos asignados a las variables
    ...
    public consulempleado() {
        ...
        try {
            ...
            String sql ="select DOC_EMPLEADO,NOMBRE_EMPLEADO,APELLIDO_EMPLEADO,DIRECCION_EMPLEADO,TELEFONO_EMPLEADO,CORREO_EMPLEADO,TIPO_EMPLEADO from EMPLEADO";
    ...
    private void initComponents() {
        ...
        tablaempleado.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "DOCUMENTO", "NOMBRE ", "APELLIDO", "DIRECCION", "TELEFONO", "CORREO", "TIPO USUARIO"
            }
        ) {
        ...
        items.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "DOCUMENTO", "NOMBRE", "APELLIDO", "DIRECCION", "TELEFONO", "CORREO", "TIPO USUARIO" }));
        ...
        titulo.setText("Registros empleados");
        ...
        tipousuario2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        getContentPane().add(tipousuario2);
        tipousuario2.setBounds(140, 40, 120, 30);
    ...
    if(consultar.equals("DOCUMENTO"))//si el dato escogido es igual a id realice lo siguiente 
    {
        ...
        try {
            ...
            String sql ="select DOC_EMPLEADO,NOMBRE_EMPLEADO,APELLIDO_EMPLEADO,DIRECCION_EMPLEADO,TELEFONO_EMPLEADO,CORREO_EMPLEADO,TIPO_EMPLEADO from EMPLEADO where DOC_EMPLEADO= ? ";
            ps=con.prepareStatement(sql);
    ...
    if(consultar.equals("NOMBRE"))//si el dato escogido es igual a nombrematerial  realice lo siguiente 
    {
        ...
        try {
            ...
            String sql ="select DOC_EMPLEADO,NOMBRE_EMPLEADO,APELLIDO_EMPLEADO,DIRECCION_EMPLEADO,TELEFONO_EMPLEADO,CORREO_EMPLEADO,TIPO_EMPLEADO from EMPLEADO where NOMBRE_EMPLEADO like '%"+ress+"%' ";
            ps=con.prepareStatement(sql);
    ...
    if(consultar.equals("APELLIDO"))//si el dato escogido es igual a cantidad  realice lo siguiente
    {
        ...
        try {
            ...
            String sql ="select DOC_EMPLEADO,NOMBRE_EMPLEADO,APELLIDO_EMPLEADO,DIRECCION_EMPLEADO,TELEFONO_EMPLEADO,CORREO_EMPLEADO,TIPO_EMPLEADO from EMPLEADO where APELLIDO_EMPLEADO like '%"+ress+"%' ";
            ps=con.prepareStatement(sql);
            //ps.setInt(1,Integer.parseInt(registro.getText()));
            rs=ps.executeQuery();
        ...
        if(consultar.equals("DIRECCION"))//si el dato escogido es igual a cantidad  realice lo siguiente
        {
        String  ress= registro.getText();
        try {
            DefaultTableModel modelo=new DefaultTableModel();
            ...
            String sql ="select DOC_EMPLEADO,NOMBRE_EMPLEADO,APELLIDO_EMPLEADO,DIRECCION_EMPLEADO,TELEFONO_EMPLEADO,CORREO_EMPLEADO,TIPO_EMPLEADO from EMPLEADO where DIRECCION_EMPLEADO like '%"+ress+"%' ";
            ps=con.prepareStatement(sql);
            //ps.setInt(1,Integer.parseInt(registro.getText()));
            rs=ps.executeQuery();
    ...
    if(consultar.equals("TELEFONO"))//si el dato escogido es igual a precio  realice lo siguiente
    {
        ...
        try {
            ...
            String sql ="select DOC_EMPLEADO,NOMBRE_EMPLEADO,APELLIDO_EMPLEADO,DIRECCION_EMPLEADO,TELEFONO_EMPLEADO,CORREO_EMPLEADO,TIPO_EMPLEADO from EMPLEADO where TELEFONO_EMPLEADO like '%"+ress+"%' ";
            ps=con.prepareStatement(sql);
            //ps.setInt(1,Integer.parseInt(registro.getText()));
            rs=ps.executeQuery();
        ...
        if(consultar.equals("CORREO"))//si el dato escogido es igual a precio  realice lo siguiente
    {
        ...
        try {
            ...
            String sql ="select DOC_EMPLEADO,NOMBRE_EMPLEADO,APELLIDO_EMPLEADO,DIRECCION_EMPLEADO,TELEFONO_EMPLEADO,CORREO_EMPLEADO,TIPO_EMPLEADO from EMPLEADO where CORREO_EMPLEADO like '%"+ress+"%' ";
            ps=con.prepareStatement(sql);
            //ps.setInt(1,Integer.parseInt(registro.getText()));
            rs=ps.executeQuery();
        ...
        if(consultar.equals("TIPO USUARIO"))//si el dato escogido es igual a precio  realice lo siguiente
            {
            String  ress= registro.getText();
        try {
            DefaultTableModel modelo=new DefaultTableModel();
            ...
            String sql ="select DOC_EMPLEADO,NOMBRE_EMPLEADO,APELLIDO_EMPLEADO,DIRECCION_EMPLEADO,TELEFONO_EMPLEADO,CORREO_EMPLEADO,TIPO_EMPLEADO from EMPLEADO where TIPO_EMPLEADO like '%"+ress+"%' ";
            ps=con.prepareStatement(sql);
            //ps.setInt(1,Integer.parseInt(registro.getText()));
            rs=ps.executeQuery();
    ...
    private void VolverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VolverActionPerformed
        opcem mp=new opcem();//cuando de click en volver lo envie al modulo de materi prima 
        mp.setVisible(true);
        dispose();
        if (tipousuario2.getText().equals("USUARIO")){
                mp.tipousuario24.setText("USUARIO");
        }
        if(tipousuario2.getText().equals("ADMINISTRADOR")){
                mp.tipousuario24.setText("ADMINISTRADOR");
        }
...
try {
    ...
    private void editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarActionPerformed
        crudempleado cm=new crudempleado();
        cm.setVisible(true);
        dispose();
        if (tipousuario2.getText().equals("USUARIO")){
                cm.tipousuario11.setText("USUARIO");
        }
        if(tipousuario2.getText().equals("ADMINISTRADOR")){
                cm.tipousuario11.setText("ADMINISTRADOR");
        } 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(consulempleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new consulempleado().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JLabel tipousuario2;
