...
public class opc extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tipousuario21 = new javax.swing.JLabel();
        ...
        titulo.setText("Menú del modulo de materia prima");
        ...
        volver.setBounds(480, 460, 65, 65);

        tipousuario21.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        getContentPane().add(tipousuario21);
        tipousuario21.setBounds(20, 100, 150, 30);
    ...
    private void consultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarActionPerformed
        ...
        con.setVisible(true);
        dispose();
        if (tipousuario21.getText().equals("USUARIO")){
                con.tipousuario5.setText("USUARIO");
        }
        if(tipousuario21.getText().equals("ADMINISTRADOR")){
                con.tipousuario5.setText("ADMINISTRADOR");
        }
    ...
    private void eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarActionPerformed
        crudmateria el=new crudmateria();
        el.setVisible(true);
        dispose();
        if (tipousuario21.getText().equals("USUARIO")){
                el.tipousuario12.setText("USUARIO");
        }
        if(tipousuario21.getText().equals("ADMINISTRADOR")){
                el.tipousuario12.setText("ADMINISTRADOR");
        }
    ...
    public javax.swing.JLabel tipousuario21;
