...
public class menudevoluciones extends javax.swing.JFrame {


    public menudevoluciones(){
        initComponents();
    ...
    private void initComponents() {
        ...
        tipousuario17 = new javax.swing.JLabel();
        ...
        titulo.setText("Menú del modulo devoluciones");
        ...
        titulo.setBounds(240, 40, 720, 90);
        ...
        consultar.setBounds(550, 200, 180, 180);
        ...
        eliminar.setBounds(270, 200, 180, 180);
        ...
        volver.setBounds(470, 450, 65, 65);

        tipousuario17.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        getContentPane().add(tipousuario17);
        tipousuario17.setBounds(30, 100, 140, 30);
    ...
    private void consultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarActionPerformed
        consultasdevoluciones con=new consultasdevoluciones();
        con.setVisible(true);
        dispose();
        if (tipousuario17.getText().equals("USUARIO")){
                con.tipousuario6.setText("USUARIO");
        }
        if(tipousuario17.getText().equals("ADMINISTRADOR")){
                con.tipousuario6.setText("ADMINISTRADOR");
        }
    ...
    private void eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarActionPerformed
        cruddevoluciones el=new cruddevoluciones();
        el.setVisible(true);
        dispose();
        if (tipousuario17.getText().equals("USUARIO")){
                el.tipousuario10.setText("USUARIO");
        }
        if(tipousuario17.getText().equals("ADMINISTRADOR")){
                el.tipousuario10.setText("ADMINISTRADOR");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(menudevoluciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                    new menudevoluciones().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JLabel tipousuario17;
