...
//creamos una clase publica con los siguientes metodos asignados a las variables
    ...
    public consulproductos() {
        ...
        try {
            ...
            String sql ="select ID_CHAQUETA_REALIZADAA,NOMBRE_CHAQUETA_REALIZADA,NOMBRE_ESTILO_PRODUCTO,VALOR_CHAQUETA_REALIZADA,ESTADO,GENERO,COLOR from CHAQUETA_REALIZADA";
    ...
    private void initComponents() {
        ...
        tipousuario3 = new javax.swing.JLabel();
        ...
        tablaproduc.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id chaqueta", "Nombre chaqueta ", "Estilo chaqueta", "Valor ", "estado", "Genero", "Color"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.Integer.class, java.lang.Object.class, java.lang.String.class, java.lang.Integer.class
            };
        ...
        semititulo.setBounds(10, 640, 200, 20);

        registro.setBackground(new java.awt.Color(204, 204, 255));
        getContentPane().add(registro);
        registro.setBounds(230, 640, 156, 29);

        items.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID CHAQUETA", "NOMBRE CHAQUETA", "ESTILO", "VALOR", "GENERO", "COLOR", "DISPONIBLES" }));
        ...
        Volver.setBounds(860, 620, 65, 65);

        titulo.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        titulo.setForeground(new java.awt.Color(51, 51, 255));
        titulo.setText("Registros chaquetas");
        ...
        editar.setBounds(720, 620, 65, 65);

        tipousuario3.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        getContentPane().add(tipousuario3);
        tipousuario3.setBounds(130, 40, 150, 30);
    ...
    if(consultar.equals("ID CHAQUETA"))//si el dato escogido es igual a id realice lo siguiente 
    {
        try {
            DefaultTableModel modelo=new DefaultTableModel();
            tablaproduc.setModel(modelo);
            ...
            String sql ="select ID_CHAQUETA_REALIZADAA,NOMBRE_CHAQUETA_REALIZADA,NOMBRE_ESTILO_PRODUCTO,VALOR_CHAQUETA_REALIZADA,ESTADO,GENERO,COLOR from CHAQUETA_REALIZADA where ID_CHAQUETA_REALIZADAA= ? ";
            ps=con.prepareStatement(sql);
    ...
    if(consultar.equals("NOMBRE CHAQUETA"))//si el dato escogido es igual a nombrematerial  realice lo siguiente 
    {
        ...
        try {
            ...
            String sql ="select ID_CHAQUETA_REALIZADAA,NOMBRE_CHAQUETA_REALIZADA,NOMBRE_ESTILO_PRODUCTO,VALOR_CHAQUETA_REALIZADA,ESTADO,GENERO,COLOR from CHAQUETA_REALIZADA where NOMBRE_CHAQUETA_REALIZADA like'%"+ress+"%' ";
            ps=con.prepareStatement(sql);
    ...
    if(consultar.equals("ESTILO"))//si el dato escogido es igual a cantidad  realice lo siguiente
    {
        String  ress= registro.getText();
        try {
            DefaultTableModel modelo=new DefaultTableModel();
            ...
            String sql ="select ID_CHAQUETA_REALIZADAA,NOMBRE_CHAQUETA_REALIZADA,NOMBRE_ESTILO_PRODUCTO,VALOR_CHAQUETA_REALIZADA,ESTADO,GENERO,COLOR from CHAQUETA_REALIZADA where NOMBRE_ESTILO_PRODUCTO like'%"+ress+"%' ";
            ps=con.prepareStatement(sql);
            //ps.setInt(1,Integer.parseInt(registro.getText()));
            rs=ps.executeQuery();
    ...
    if(consultar.equals("VALOR"))//si el dato escogido es igual a precio  realice lo siguiente
    {
        ...
        try {
            ...
            String sql ="select ID_CHAQUETA_REALIZADAA,NOMBRE_CHAQUETA_REALIZADA,NOMBRE_ESTILO_PRODUCTO,VALOR_CHAQUETA_REALIZADA,ESTADO,GENERO,COLOR from CHAQUETA_REALIZADA where VALOR_CHAQUETA_REALIZADA like ? ";
            ps=con.prepareStatement(sql);
            ps.setInt(1,Integer.parseInt(registro.getText()));
            rs=ps.executeQuery();
        ...
        if(consultar.equals("GENERO"))//si el dato escogido es igual a precio  realice lo siguiente
    {
            String  ress= registro.getText();
        try {
            DefaultTableModel modelo=new DefaultTableModel();
            ...
            String sql ="select ID_CHAQUETA_REALIZADAA,NOMBRE_CHAQUETA_REALIZADA,NOMBRE_ESTILO_PRODUCTO,VALOR_CHAQUETA_REALIZADA,ESTADO,GENERO,COLOR from CHAQUETA_REALIZADA where GENERO like'%"+ress+"%'  ";
            ps=con.prepareStatement(sql);
            //ps.setInt(1,Integer.parseInt(registro.getText()));
            rs=ps.executeQuery();
        ...
        if(consultar.equals("COLOR"))//si el dato escogido es igual a precio  realice lo siguiente
    {
        ...
        try {
            ...
            String sql ="select ID_CHAQUETA_REALIZADAA,NOMBRE_CHAQUETA_REALIZADA,NOMBRE_ESTILO_PRODUCTO,VALOR_CHAQUETA_REALIZADA,ESTADO,GENERO,COLOR from CHAQUETA_REALIZADA where COLOR like'%"+ress+"%'";
            ps=con.prepareStatement(sql);
            //ps.setInt(1,Integer.parseInt(registro.getText()));
            rs=ps.executeQuery();
 ...
 if(consultar.equals("DISPONIBLES"))//si el dato escogido es igual a precio  realice lo siguiente
    {
        try {
            DefaultTableModel modelo=new DefaultTableModel();
            tablaproduc.setModel(modelo);
            ...
            String sql ="select ID_CHAQUETA_REALIZADAA,NOMBRE_CHAQUETA_REALIZADA,NOMBRE_ESTILO_PRODUCTO,VALOR_CHAQUETA_REALIZADA,ESTADO,GENERO,COLOR from CHAQUETA_REALIZADA where ESTADO like 'DISPONIBLE'";
            ps=con.prepareStatement(sql);
            //ps.setInt(1,Integer.parseInt(registro.getText()));
            rs=ps.executeQuery();
    ...
    private void VolverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VolverActionPerformed
        opccha mp=new opccha();//cuando de click en volver lo envie al modulo de materi prima 
        mp.setVisible(true);
        dispose();
        if (tipousuario3.getText().equals("USUARIO")){
                mp.tipousuario22.setText("USUARIO");
        }
        if(tipousuario3.getText().equals("ADMINISTRADOR")){
                mp.tipousuario22.setText("ADMINISTRADOR");
        }
    ...
    private void editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarActionPerformed
        crudproductos cm=new crudproductos();
        cm.setVisible(true);
        dispose();
        if (tipousuario3.getText().equals("USUARIO")){
                cm.tipousuario14.setText("USUARIO");
        }
        if(tipousuario3.getText().equals("ADMINISTRADOR")){
                cm.tipousuario14.setText("ADMINISTRADOR");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(consulproductos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new consulproductos().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JLabel tipousuario3;
