...
public class opcem extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tipousuario24 = new javax.swing.JLabel();
        ...
        titulo.setText("Menu del modulo de empleados ");
        ...
        consultar.setBounds(560, 210, 180, 180);
        ...
        eliminar.setBounds(300, 210, 180, 180);
        ...
        volver.setBounds(490, 460, 65, 65);

        tipousuario24.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        getContentPane().add(tipousuario24);
        tipousuario24.setBounds(20, 100, 150, 30);
    ...
    private void consultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarActionPerformed
        consulempleado con=new consulempleado();
        con.setVisible(true);
        dispose();
        if (tipousuario24.getText().equals("USUARIO")){
                con.tipousuario2.setText("USUARIO");
        }
        if(tipousuario24.getText().equals("ADMINISTRADOR")){
                con.tipousuario2.setText("ADMINISTRADOR");
        }
    ...
    private void eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarActionPerformed
        crudempleado el=new crudempleado();
        el.setVisible(true);
        dispose();
        if (tipousuario24.getText().equals("USUARIO")){
                el.tipousuario11.setText("USUARIO");
        }
        if(tipousuario24.getText().equals("ADMINISTRADOR")){
                el.tipousuario11.setText("ADMINISTRADOR");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(opcem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public javax.swing.JLabel tipousuario24;
