...
public class menuventas1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tipousuario20 = new javax.swing.JLabel();
        ...
        consultar.setBounds(470, 200, 180, 180);
        ...
        eliminar.setBounds(220, 200, 180, 180);
        ...
        volver.setBounds(390, 450, 65, 65);

        tipousuario20.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        getContentPane().add(tipousuario20);
        tipousuario20.setBounds(20, 100, 150, 30);
    ...
    private void consultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarActionPerformed
        ...
        con.setVisible(true);
        dispose();
        if (tipousuario20.getText().equals("USUARIO")){
                con.tipousuario8.setText("USUARIO");
        }
        if(tipousuario20.getText().equals("ADMINISTRADOR")){
                con.tipousuario8.setText("ADMINISTRADOR");
        }
    ...
    private void eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarActionPerformed
        crudventas el=new crudventas();
        el.setVisible(true);
        dispose();
        if (tipousuario20.getText().equals("USUARIO")){
                el.tipousuario16.setText("USUARIO");
        }
        if(tipousuario20.getText().equals("ADMINISTRADOR")){
                el.tipousuario16.setText("ADMINISTRADOR");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(menuventas1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                    new menuventas1().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JLabel tipousuario20;
